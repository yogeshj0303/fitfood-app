...
TrainerCartModel trainerCartModelFromJson(String str) =>
    TrainerCartModel.fromJson(json.decode(str));
String trainerCartModelToJson(TrainerCartModel data) =>
    json.encode(data.toJson());

class TrainerCartModel {
  TrainerCartModel({
    bool? error,
    Data? data,
    String? message,
  ...
  TrainerCartModel.fromJson(dynamic json) {
    _error = json['error'];
...
class CartItems {
  ...
  String? get tempDiscount => _tempDiscount;
